...
class _HomeWidget extends State<HomePage>{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(title: const Text("Memo",style: TextStyle(color: Colors.white),),centerTitle: true,backgroundColor: Colors.black, iconTheme: const IconThemeData(color: Colors.white),),
      drawer: Drawer(
        ...
        child: ListView(padding: EdgeInsets.zero, children: <Widget>[ const DrawerHeader(decoration: BoxDecoration(color: Colors.black,),
            child: Align(alignment: Alignment.centerLeft,child: Text('Memo', style: TextStyle(color: Colors.white, fontSize: 24,),),)),
          ...
          ListTile(
            ...
            title: const Text('Go to chrome',style: TextStyle(fontSize: 14,color: Colors.black),),
            onTap: () {
          ...
          ListTile(
            ...
            title: Text('LogOut',style: const TextStyle(fontSize: 14,color: Colors.black),),
            onTap: () {
              prefs.setString(LOCATION_SP_USER_INFO_KEY, "");
              prefs.setString(LOCATION_SP_USER_INFO_ID_KEY, "");
